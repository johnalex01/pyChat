...
class m_frameLogin (wx.Frame):
    ...
    def __init__(self, parent):
        ...
        self.m_statictextportName = wx.StaticText(
            self, wx.ID_ANY, u"PORT", wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        fgSizer3.Add(self.m_statictextUsername, 0, wx.ALL | wx.ALIGN_RIGHT, 5)
        ...
        gSizer6.Add(fgSizer3, 1, wx.EXPAND, 5)
        ...
        self.m_button88 = wx.Button(
            self, wx.ID_ANY, u"MyButton", wx.DefaultPosition, wx.DefaultSize, 0)
        bSizer16.Add(self.m_button88, 0, wx.ALL, 5)

        gSizer6.Add(bSizer16, 0, wx.EXPAND, 5)
