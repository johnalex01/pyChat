...
class m_frameChatRoom (wx.Frame):
    ...
    def __init__(self, parent):
        ...
        self.m_textChatsNotice = wx.TextCtrl(self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size(
            -1, 185), wx.TE_MULTILINE | wx.TE_NO_VSCROLL | wx.TE_READONLY)
        fgSizer4.Add(self.m_textChatsNotice, 0, wx.ALL, 5)

        self.m_textOnlinePeople = wx.TextCtrl(self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size(
            -1, 185), wx.TE_MULTILINE | wx.TE_NO_VSCROLL | wx.TE_READONLY)
        fgSizer4.Add(self.m_textOnlinePeople, 0, wx.ALL, 5)
